 ...
 */
            ...
            /**
            *  ChangeSampleRateResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ChangeSampleRateResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://guwi.com",
                "changeSampleRateResponse",
                "ns1");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":changeSampleRateResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "changeSampleRateResponse",
    ...
    public static class Factory{
        ...
        */
        public static ChangeSampleRateResponse parse(javax.xml.stream.XMLStreamReader reader) throws Exception{
            ChangeSampleRateResponse object =
                new ChangeSampleRateResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"changeSampleRateResponse".equals(type)){
                                //find namespace for the prefix
                                String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ChangeSampleRateResponse)com.guwi.altermusicstubs.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
