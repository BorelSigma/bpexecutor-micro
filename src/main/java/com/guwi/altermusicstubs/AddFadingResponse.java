 ...
 */
            ...
            /**
            *  AddFadingResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class AddFadingResponse
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":addFadingResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "addFadingResponse",
    ...
    public static class Factory{
        ...
        */
        public static AddFadingResponse parse(javax.xml.stream.XMLStreamReader reader) throws Exception{
            AddFadingResponse object =
                new AddFadingResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"addFadingResponse".equals(type)){
                                //find namespace for the prefix
                                String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AddFadingResponse)com.guwi.altermusicstubs.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
