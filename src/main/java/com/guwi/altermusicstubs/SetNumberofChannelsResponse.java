...
/**
 * SetNumberofChannelsResponse.java
 *
 ...
 */
            ...
            /**
            *  SetNumberofChannelsResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class SetNumberofChannelsResponse
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":setNumberofChannelsResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "setNumberofChannelsResponse",
    ...
    public static class Factory{
        ...
        */
        public static SetNumberofChannelsResponse parse(javax.xml.stream.XMLStreamReader reader) throws Exception{
            SetNumberofChannelsResponse object =
                new SetNumberofChannelsResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"setNumberofChannelsResponse".equals(type)){
                                //find namespace for the prefix
                                String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SetNumberofChannelsResponse)com.guwi.altermusicstubs.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://guwi.com","return").equals(reader.getName()) || new javax.xml.namespace.QName("","return").equals(reader.getName()) ){
