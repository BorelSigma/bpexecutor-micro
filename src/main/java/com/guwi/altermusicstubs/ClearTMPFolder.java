 ...
 */
            ...
            /**
            *  ClearTMPFolder bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ClearTMPFolder
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":clearTMPFolder",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "clearTMPFolder",
    ...
    public static class Factory{
        ...
        */
        public static ClearTMPFolder parse(javax.xml.stream.XMLStreamReader reader) throws Exception{
            ClearTMPFolder object =
                new ClearTMPFolder();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"clearTMPFolder".equals(type)){
                                //find namespace for the prefix
                                String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ClearTMPFolder)com.guwi.altermusicstubs.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
