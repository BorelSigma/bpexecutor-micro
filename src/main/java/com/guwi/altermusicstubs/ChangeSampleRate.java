 ...
 */
        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns1");
                        ...
                        */
                        ...
                        /**
                        * field for Sample_rate
                        */

                        
                                    protected int localSample_rate ;
                           ...
                           */
                           public  int getSample_rate(){
                            ...
                            /**
                               * Auto generated setter method
                               * @param param Sample_rate
                               */
                               public void setSample_rate(int param){
                            
                                            this.localSample_rate=param;
       ...
       public org.apache.axiom.om.OMElement getOMElement (
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                String namespace = null;
                  ...
                  if (serializeType){
                   ...
                   String namespacePrefix = registerPrefix(xmlWriter,"http://guwi.com");
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":changeSampleRate",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "changeSampleRate",
                ...
                if (localFile_nameTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    namespace = "http://guwi.com";
                                    writeStartElement(null, namespace, "sample_rate", xmlWriter);
                             
                                               if (localSample_rate== Integer.MIN_VALUE) {
                                           
                                                         throw new org.apache.axis2.databinding.ADBException("sample_rate cannot be null!!");
                                                      
                                               } else {
                                                    xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localSample_rate));
                                               }
        ...
        private static String generatePrefix(String namespace) {
            if(namespace.equals("http://guwi.com")){
                return "ns1";
            }
    ...
    public static class Factory{
        ...
        */
        public static ChangeSampleRate parse(javax.xml.stream.XMLStreamReader reader) throws Exception{
            ChangeSampleRate object =
                new ChangeSampleRate();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"changeSampleRate".equals(type)){
                                //find namespace for the prefix
                                String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ChangeSampleRate)com.guwi.altermusicstubs.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://guwi.com","file_name").equals(reader.getName()) || new javax.xml.namespace.QName("","file_name").equals(reader.getName()) ){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://guwi.com","data").equals(reader.getName()) || new javax.xml.namespace.QName("","data").equals(reader.getName()) ){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://guwi.com","sample_rate").equals(reader.getName()) || new javax.xml.namespace.QName("","sample_rate").equals(reader.getName()) ){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"sample_rate" +"  cannot be null");
                                    }
                                    

                                    String content = reader.getElementText();
                                    
                                              object.setSample_rate(
