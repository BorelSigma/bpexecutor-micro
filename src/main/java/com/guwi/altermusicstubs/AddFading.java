 ...
 */
            ...
            /**
            *  AddFading bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class AddFading
                           ...
                           */
                           public  float getFading(){
                            ...
                            /**
                               ...
                               * @param param Fading
                               */
                               public void setFading(float param){
                            
                                            this.localFading=param;
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                if (localFile_nameTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    namespace = "http://guwi.com";
                                    writeStartElement(null, namespace, "fading", xmlWriter);
                             
                                               if (Float.isNaN(localFading)) {
                                           
                                                         throw new org.apache.axis2.databinding.ADBException("fading cannot be null!!");
                                                      
                                               } else {
                                                    xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localFading));
                                               }
    ...
    public static class Factory{
        ...
        */
        public static AddFading parse(javax.xml.stream.XMLStreamReader reader) throws Exception{
            AddFading object =
                new AddFading();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"addFading".equals(type)){
                                //find namespace for the prefix
                                String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AddFading)com.guwi.altermusicstubs.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://guwi.com","fading").equals(reader.getName()) || new javax.xml.namespace.QName("","fading").equals(reader.getName()) ){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"fading" +"  cannot be null");
                                    }
