 ...
 */
            ...
            /**
            *  GetTampName bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetTampName
    ...
    public static class Factory{
        ...
        */
        public static GetTampName parse(javax.xml.stream.XMLStreamReader reader) throws Exception{
            GetTampName object =
                new GetTampName();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getTampName".equals(type)){
                                //find namespace for the prefix
                                String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetTampName)com.guwi.altermusicstubs.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
